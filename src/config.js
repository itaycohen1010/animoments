...
export const config = {
  ...
  announcement: '25% הנחה- WELCOME25',
  ...
  promoImage: 'https://res.cloudinary.com/dmxkoz4jo/image/upload/v1784134979/Launch_Flyer_y1a88b.png', // optional image URL shown in the popup instead of text
